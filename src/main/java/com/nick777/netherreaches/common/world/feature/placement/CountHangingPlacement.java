...
public class CountHangingPlacement extends Placement<FrequencyConfig> {
    private final PlacementLevel placementLevel;

    public CountHangingPlacement(Function<Dynamic<?>, ? extends FrequencyConfig> deserialize, PlacementLevel placementLevel) {
        super(deserialize);
