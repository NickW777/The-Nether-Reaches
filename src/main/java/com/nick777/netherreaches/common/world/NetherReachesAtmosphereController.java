...
public final class NetherReachesAtmosphereController {
    public static final NetherReachesAtmosphereController INSTANCE = new NetherReachesAtmosphereController();
    ...
    private NetherReachesAtmosphereController() {
    }
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (player == null || !NetherReachesUtil.isNetherReachesDimension(player.world)) return;
