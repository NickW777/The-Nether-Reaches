...
public class ChanceHeatedPlacement extends Placement<ChanceConfig> {
    private final PlacementLevel placementLevel;

    public ChanceHeatedPlacement(Function<Dynamic<?>, ? extends ChanceConfig> deserialize, PlacementLevel placementLevel) {
        super(deserialize);
