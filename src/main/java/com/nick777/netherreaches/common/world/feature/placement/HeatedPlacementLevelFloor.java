...
public class HeatedPlacementLevelFloor implements PlacementLevel {
    public static final PlacementLevel INSTANCE = new HeatedPlacementLevelFloor();

    private HeatedPlacementLevelFloor() {
    }
