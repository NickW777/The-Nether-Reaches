...
public abstract class NetherReachesLootTableProvider implements IDataProvider {
    ...
    public NetherReachesLootTableProvider(DataGenerator generator, LootParameterSet lootSet) {
    ...
    public String getName() {
        return "Nether Reaches Loot Tables";
    }
}
