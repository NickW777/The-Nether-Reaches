...
public class BiomeLayerType<T> {
    ...
    public static final BiomeLayerType<IslandBiome> ISLAND = BiomeLayerType.create(IslandBiome.class, BiomeLayerType::buildIsland, NetherReachesIslandBiomes::byId, NetherReachesIslandBiomes.RUINED);
    ...
    private static <A extends IArea, C extends IExtendedNoiseRandom<A>> BiomeProcedure<A> buildDamp(LongFunction<C> contextFactory) {
        int wetForestId = NetherReachesDampBiomes.getId(NetherReachesDampBiomes.WET_FOREST);
    ...
    private static <A extends IArea, C extends IExtendedNoiseRandom<A>> BiomeProcedure<A> buildIsland(LongFunction<C> contextFactory) {
        int wetForestId = NetherReachesDampBiomes.getId(NetherReachesDampBiomes.WET_FOREST);
