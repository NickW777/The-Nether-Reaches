...
public final class NetherReachesSurfaceBuilders {
    public static final SurfaceBuilder<SurfaceBuilderConfig> HANGING = new LayeredSurfaceBuilder(SurfaceBuilderConfig::deserialize, 0, 0);

    public static final SurfaceBuilder<SurfaceBuilderConfig> HEATED = new LayeredSurfaceBuilder(SurfaceBuilderConfig::deserialize, 1, Integer.MAX_VALUE)
            .withMaxY(NetherReachesChunkGenerator.SURFACE_CAVE_BOUNDARY);
