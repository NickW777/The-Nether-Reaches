...
public class NetherReachesItemGroups {
    ...
    public static final ItemGroup BUILDING = new ItemGroup("netherreaches_building") {
        ...
        public void fill(NonNullList<ItemStack> items) {
            List<Item> building = Arrays.asList(HEATED_DIRT.asItem(), COARSE_HEATED_DIRT.asItem(), HEATED_GRASS_BLOCK.asItem(), FLASH_OBSIDIAN.asItem(),
                    ...
                    AQUANE_SHELF_SHROOM_CORE.asItem(), CRELENOR_SHELF_SHROOM_CORE.asItem(), GREJAR_SHELF_SHROOM_CORE.asItem(), MOISE_SHELF_SHROOM_CORE.asItem(),
                    SABLE_SHELF_SHROOM_CORE.asItem(), AQUANE_SHELF_SHROOM_CRUST.asItem(), CRELENOR_SHELF_SHROOM_CRUST.asItem(), GREJAR_SHELF_SHROOM_CRUST.asItem(),
                    MOISE_SHELF_SHROOM_CRUST.asItem(), SABLE_SHELF_SHROOM_CRUST.asItem(), AQUANE_SHELF_SHROOM_PASTE.asItem(), CRELENOR_SHELF_SHROOM_PASTE.asItem(),
                    GREJAR_SHELF_SHROOM_PASTE.asItem(), MOISE_SHELF_SHROOM_PASTE.asItem(), SABLE_SHELF_SHROOM_PASTE.asItem(),
    ...
    public static final ItemGroup ITEM = new ItemGroup("netherreaches_item") {
        ...
        public void fill(NonNullList<ItemStack> items) {
            List<Item> itemList = Arrays.asList(BLACK_REACHCRYSTAL_SHARD, BLUE_REACHCRYSTAL_SHARD, BROWN_REACHCRYSTAL_SHARD, CYAN_REACHCRYSTAL_SHARD,
                    ...
                    SHADE_STICK, SHOCK_STICK, TANGLE_STICK, TOXIC_STICK, REACH_WATER_BUCKET, MAGMA_BUCKET, ENGULFED_SPAWN_EGG);
            items.clear();
