...
public class NetherReachesBlocks {
    ...
    public static final Block FLASH_OBSIDIAN = Blocks.DIRT;
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
        ...
        RegUtil.blocks(event.getRegistry())
                .withProperties(() -> Block.Properties
                        ...
                        .hardnessAndResistance(55F, 1300f)
                        .sound(SoundType.STONE)
                        .harvestTool(ToolType.PICKAXE)
                        .harvestLevel(3)
                )
                .add("flash_obsidian", Block::new);
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        RegUtil.items(event.getRegistry())
                ...
                .addAll(BlockItem::new,
                        HEATED_DIRT, COARSE_HEATED_DIRT, HEATED_GRASS_BLOCK, FLASH_OBSIDIAN,
