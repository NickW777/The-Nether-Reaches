...
public class TangleShroomCapBlock extends LeavesBlock {
    ...
    public void animateTick(BlockState state, World world, BlockPos pos, Random rand) {
        if (rand.nextInt(8) == 0) {
            NetherReachesParticles.TANGLE_SHROOM.spawn(world, pos.getX() + 1d, pos.getY() + 1d, pos.getZ() + 1d, rand.nextFloat() * 0.1d - 0.05d, rand.nextFloat() * 0.03d, rand.nextFloat() * 0.1d - 0.05d);
        }
    }
