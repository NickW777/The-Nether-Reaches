...
@OnlyIn(Dist.CLIENT)
abstract class NetherReachesParticle extends TexturedParticle implements IParticleRenderType {
    protected NetherReachesParticle(World world, double x, double y, double z) {
        super(world, x, y, z);
    }

    protected NetherReachesParticle(World world, double x, double y, double z, double motionX, double motionY, double motionZ) {
