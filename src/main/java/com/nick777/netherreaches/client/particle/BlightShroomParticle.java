...
@OnlyIn(Dist.CLIENT)
public class BlightShroomParticle extends NetherReachesParticle{
    BlightShroomParticle(World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
    ...
    ResourceLocation getTexture() {
        return NetherReachesParticleSprites.BLIGHT_SHROOM;
    }
    ...
    public static class Factory implements IParticle {
        ...
        public Particle makeParticle(World world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int... params) {
            return new BlightShroomParticle(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
